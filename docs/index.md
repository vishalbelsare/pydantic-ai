...
* __Model-agnostic__
Supports OpenAI, Anthropic, Gemini, Deepseek, Ollama, Groq, Cohere, Mistral, and there is a simple interface to implement support for [other models](https://ai.pydantic.dev/models/).
