...
[
    ...
    ModelResponse(
        ...
        usage=Usage(requests=1, input_tokens=90, output_tokens=2, total_tokens=92),
    ...
    ModelResponse(
        ...
        usage=Usage(requests=1, input_tokens=91, output_tokens=4, total_tokens=95),
        model_name='gemini-1.5-flash',
        timestamp=datetime.datetime(...),
    ),
    ModelRequest(
    ...
    ModelResponse(
        ...
        usage=Usage(
            requests=1, input_tokens=92, output_tokens=12, total_tokens=104
        ),
        model_name='gemini-1.5-flash',
        timestamp=datetime.datetime(...),
    ),
