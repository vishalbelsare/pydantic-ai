...
# EU models available in AWS Bedrock Europe regions
# See https://docs.aws.amazon.com/bedrock/latest/userguide/models-supported.html for all supported models
