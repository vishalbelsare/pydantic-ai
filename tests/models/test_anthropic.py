...
""")
    ...
    assert result.new_messages() == snapshot(
        [
            ...
            ModelResponse(
                parts=[
                    TextPart(content="Let me search for today's date."),
                    ServerToolCallPart(
                        tool_name='web_search',
                        args={'query': 'current date today May 26 2025'},
                        tool_call_id=IsStr(),
                        model_name='anthropic',
                    ),
                    ServerToolReturnPart(
...
"""
                    ...
                    TextPart(content='today is Monday, May 26, 2025 (Week 22)'),
                    TextPart(content='. This is notably '),
                    TextPart(content='Memorial Day, which was originally known as Decoration Day'),
                    TextPart(content='. '),
                    TextPart(content='The year 2025 is a regular year with 365 days'),
                    TextPart(content='.'),
                ],
                usage=Usage(
                    requests=1,
