    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=1, output_tokens=1, total_tokens=1),
    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=1, output_tokens=2, total_tokens=3),
                model_name='mistral-large-123',
                timestamp=datetime(2024, 1, 1, 0, 0, tzinfo=timezone.utc),
                provider_request_id='123',
            ),
    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=3, output_tokens=2, total_tokens=6),
                model_name='mistral-large-123',
                timestamp=datetime(2024, 1, 1, 0, 0, tzinfo=timezone.utc),
                provider_request_id='123',
            ),
    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                ...
                usage=RunUsage(input_tokens=2, output_tokens=2, total_tokens=2),
...
async def test_stream_tool_call(allow_model_requests: None):
    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                parts=[TextPart(content='final response')],
                usage=RunUsage(input_tokens=4, output_tokens=4, total_tokens=4),
                model_name='mistral-large-latest',
                timestamp=datetime(2024, 1, 1, 0, 0, tzinfo=timezone.utc),
            ),
        ]
    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                ...
                usage=RunUsage(input_tokens=1, output_tokens=1, total_tokens=1),
                model_name='mistral-large-latest',
                timestamp=datetime(2024, 1, 1, 0, 0, tzinfo=timezone.utc),
            ),
            ModelRequest(
    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=65, output_tokens=16, total_tokens=81),
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=2931, output_tokens=70, total_tokens=3001),
                model_name='pixtral-12b-latest',
                timestamp=IsDatetime(),
...
"""
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=1036, output_tokens=691, total_tokens=1727),
                model_name='mistral-large-latest',
                timestamp=IsDatetime(),
