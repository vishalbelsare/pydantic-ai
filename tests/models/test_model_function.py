    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=51, output_tokens=3, total_tokens=54),
    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=56, output_tokens=11, total_tokens=67),
                model_name='function:weather_model:',
                timestamp=IsNow(tz=timezone.utc),
            ),
            ModelRequest(
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=57, output_tokens=14, total_tokens=71),
                model_name='function:weather_model:',
                timestamp=IsNow(tz=timezone.utc),
            ),
        ]
    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=52, output_tokens=21, total_tokens=73),
                model_name='test',
                timestamp=IsNow(tz=timezone.utc),
            ),
            ModelRequest(
            ...
            ModelResponse(
                ...
                usage=RunUsage(requests=1, input_tokens=57, output_tokens=33, total_tokens=90),
                model_name='test',
                timestamp=IsNow(tz=timezone.utc),
            ),
        ]
...
async def test_stream_text():
    ...
    async with agent.run_stream('') as result:
        ...
        assert result.usage() == snapshot(RunUsage(requests=1, input_tokens=50, output_tokens=2, total_tokens=52))
